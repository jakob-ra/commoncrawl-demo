# -*- coding: utf-8 -*-
"""
Created on Fri Jul 30 12:00:26 2021
...
Notes:
Guide to accessing data is given at https://commoncrawl.org/the-data/get-started/

We are going to try and get the WARC files based on the following guide
https://skeptric.com/text-meta-data-commoncrawl/

Parsing is done with selectolax for speed - based on https://rushter.com/blog/python-fast-html-parser/
...
df = pd.read_csv('www.dropbox.com/downloadlink')
